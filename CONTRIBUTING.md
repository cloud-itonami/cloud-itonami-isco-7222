...
`cloud-itonami-isco-7222` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, workshop or operator data, credentials or
  operating documents.
- Keep production writes and disclosures behind Toolmaker Governor.
...
- Never widen the closed op-allowlist to include a machining-execution
